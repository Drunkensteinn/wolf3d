...
/*   Updated: 2019/04/15 15:05:54 by ablizniu         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
double					calculate_len_ray(t_wolf3d *wolf,
						void (*f)(t_wolf3d *));
...
void					write_line(t_wolf3d *wolf, int32_t from, int32_t to,
						int32_t attribute);

void					validation_source(t_wolf3d *wolf,
						int32_t fd, char *path);
